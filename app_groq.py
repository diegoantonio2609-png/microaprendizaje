...
def respond(message, history: list) -> str:
    ...
    """
    if not client:
        gr.Warning("⚠️ No se encontró la clave de API. Configura GROQ_API_KEY en los Secrets del Space.")
        return "⚠️ No se encontró la clave de API. Configura GROQ_API_KEY en los Secrets del Space."
    try:
        ...
        # Devolver el mensaje de error crudo como lo solicitó el usuario por ahora
        return f"⚠️ Error al conectar con Groq: {e}"
